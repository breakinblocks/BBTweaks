package com.breakinblocks.bbtweaks.common;
...
public class CreativeTabBaseMod extends CreativeTabs {
	...
	public CreativeTabBaseMod(String tabLabel) {
		super(tabLabel);
		// setBackgroundImageName(ModInformation.ID + ".png"); // Automagically
		// has tab_ applied to it. Make sure you change the texture name.
	}
