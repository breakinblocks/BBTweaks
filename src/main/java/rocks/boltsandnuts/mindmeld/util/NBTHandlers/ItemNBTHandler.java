package rocks.boltsandnuts.mindmeld.util.NBTHandlers;
...
public final class ItemNBTHandler {
    ...
    public static void setString(ItemStack stack, String tagPlayer,
            String playerName) {
    ...
    private static NBTTagCompound GetNBTData(ItemStack stack) {
